...
class OperationDb(object):
    # 定义初始化连接数据库
    def __init__(self,host_db='10.5.4.175', user_db='zkagriguarashow', passwd_db='Ppm@eW9Gwxx8', name_db='zk_agriguara_show',port_db=33891, link_type=0 ):
                                                #host_db='218.78.116.81', user_db='zkagriguaratest', passwd_db='8Pp4@Kf3mRj6', name_db='zkagriguaratest',port_db=33894, link_type=0
                                                #host_db='10.5.4.175', user_db='zkagriguarashow', passwd_db='Ppm@eW9Gwxx8', name_db='zk_agriguara_show',port_db=33891, link_type=0
                                                #host_db='10.5.4.175', user_db='zklnagriguaradev', passwd_db='6VCxh!vSJ5Cy', name_db='zk_ln_agriguara_dev',port_db=33891, link_type=0
        self.db = name_db
        """
